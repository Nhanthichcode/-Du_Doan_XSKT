...
def export_permanent_mlops_data():
    log_action("Bắt đầu đóng gói dữ liệu tĩnh biểu đồ JS...")
    ...
    # Chỉ xử lý dữ liệu phục vụ render biểu đồ Line Chart
    historical_lines = {}
    ...
    # Đã loại bỏ hoàn toàn top_3_today và backtest_history theo yêu cầu kiến trúc mới
    final_package = {
